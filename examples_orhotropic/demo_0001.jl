...
# Material properties
par.E0 = 1.0
Ex = fill(1.0, Ferrite.getncells(grid))  # Initialize Young's modulus for all cells
Ey = fill(0.9, Ferrite.getncells(grid))  # Initialize Young's modulus for all cells
...
γ = [1]                     # Penalty factor
vf =[0.25, 0.5]                   # Volume fraction
η = [π/(4.0)]               # Filter parameter
k = [4 ]                    # Sensitivity parameter

file_name = "optim"
dir = "/Users/aminalibakhshi/Desktop/pump_vtu/ortho/"
remove_vtk_files(dir)
par.max_itr = 200

@time optim_2D_combine_orthotropic(par, Ex, Ey ,  γ, vf, η, k, file_name, dir)